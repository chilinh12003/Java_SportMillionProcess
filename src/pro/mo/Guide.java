...
public class Guide extends ContentAbstract
{
	...
	private Collection<MsgObject> AddToList() throws Exception
	{
		...
		{
			ListMessOject.clear();
			String MTContent_Current = Common.GetDefineMT_Message(mSubObj, mMatchObj, MTType.GuideKQ);
			...
			if (!MTContent_Current.equalsIgnoreCase(""))
			{
				...
				AddToMOLog(MTType.GuideKQ, MTContent_Current);
			}
			MTContent_Current = Common.GetDefineMT_Message(mSubObj, mMatchObj, MTType.GuideBT);
			if (!MTContent_Current.equalsIgnoreCase(""))
			{
				// nếu đăng ký mới thành công, thì thêm 3 MT Notify vào
				mMsgObject.setUsertext(MTContent_Current);
				...
				mMsgObject.setMsgtype(1);
				ListMessOject.add(new MsgObject(mMsgObject.clone()));
				AddToMOLog(MTType.GuideBT, MTContent_Current);
			}
			MTContent_Current = Common.GetDefineMT_Message(mSubObj, mMatchObj, MTType.GuideTS);
			if (!MTContent_Current.equalsIgnoreCase(""))
			{
				// nếu đăng ký mới thành công, thì thêm 3 MT Notify vào
				mMsgObject.setUsertext(MTContent_Current);
				...
				mMsgObject.setMsgtype(1);
				ListMessOject.add(new MsgObject(mMsgObject.clone()));
				AddToMOLog(MTType.GuideTS, MTContent_Current);
			}
			MTContent_Current = Common.GetDefineMT_Message(mSubObj, mMatchObj, MTType.GuideGB);
			if (!MTContent_Current.equalsIgnoreCase(""))
			{
				// nếu đăng ký mới thành công, thì thêm 3 MT Notify vào
				mMsgObject.setUsertext(MTContent_Current);
				...
				mMsgObject.setMsgtype(1);
				ListMessOject.add(new MsgObject(mMsgObject.clone()));
				AddToMOLog(MTType.GuideGB, MTContent_Current);
			}
			MTContent_Current = Common.GetDefineMT_Message(mSubObj, mMatchObj, MTType.GuideTV);
			if (!MTContent_Current.equalsIgnoreCase(""))
			{
				// nếu đăng ký mới thành công, thì thêm 3 MT Notify vào
				mMsgObject.setUsertext(MTContent_Current);
				...
				mMsgObject.setMsgtype(1);
				ListMessOject.add(new MsgObject(mMsgObject.clone()));
				AddToMOLog(MTType.GuideTV, MTContent_Current);
			}
			MTContent_Current = Common.GetDefineMT_Message(mSubObj, mMatchObj, MTType.GuideMaxMO);
			if (!MTContent_Current.equalsIgnoreCase(""))
			{
				// nếu đăng ký mới thành công, thì thêm 3 MT Notify vào
				mMsgObject.setUsertext(MTContent_Current);
				...
				mMsgObject.setMsgtype(1);
				ListMessOject.add(new MsgObject(mMsgObject.clone()));
				AddToMOLog(MTType.GuideMaxMO, MTContent_Current);
			}
